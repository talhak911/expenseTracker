...
export default function ExpenseTracker() {
  ...
  return (
    <div className=" ">
      ...
      <button onClick={() => setIsOpen(true)} className=" px-5 py-2.5 text-sm font-medium text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 m-5 "><span className="flex">Add Expense <IoAdd /> </span></button>
      </div>
      ...
      <table className=" overflow-x-scroll mx-auto w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 bg-white shadow-md rounded-md">
      ...
      <div className={`modal ${isOpen ? 'hidden' : 'block'} mt-5`}>
        {!isOpen &&
          <div className=" md:w-[60%] h-[50vh]  mt-2">
